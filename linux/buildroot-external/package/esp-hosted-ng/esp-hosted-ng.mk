...
ESP_HOSTED_NG_POST_RSYNC_HOOKS += ESP_HOSTED_NG_NORMALIZE_LINE_ENDINGS ESP_HOSTED_NG_APPLY_PATCH
...
define ESP_HOSTED_NG_NORMALIZE_LINE_ENDINGS
	find $(@D) -type f \( -name '*.c' -o -name '*.h' -o -name Makefile \) \
		-exec sed -i 's/\r$$//' {} +
endef
